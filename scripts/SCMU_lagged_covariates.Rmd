...
## run models
SST_half_mod <- lmer(Size ~ SST_half + (1 | Plot), data = SST_df)
SST_full_mod <- lmer(Size ~ SST_full + (1 | Plot), data = SST_df)
SST_half_lag_mod <- lmer(Size ~ SST_half_lag + (1 | Plot), data = SST_df)
SST_full_lag_mod <- lmer(Size ~ SST_full_lag + (1 | Plot), data = SST_df)
...
## run models
NPGO_half_mod <- lmer(Size ~ NPGO_half + (1 | Plot), data = NPGO_df)
NPGO_full_mod <- lmer(Size ~ NPGO_full + (1 | Plot), data = NPGO_df)
NPGO_half_lag_mod <- lmer(Size ~ NPGO_half_lag + (1 | Plot), data = NPGO_df)
NPGO_full_lag_mod <- lmer(Size ~ NPGO_full_lag + (1 | Plot), data = NPGO_df)
...
## run models
PDO_half_mod <- lmer(Size ~ PDO_half + (1 | Plot), data = PDO_df)
PDO_full_mod <- lmer(Size ~ PDO_full + (1 | Plot), data = PDO_df)
PDO_half_lag_mod <- lmer(Size ~ PDO_half_lag + (1 | Plot), data = PDO_df)
PDO_full_lag_mod <- lmer(Size ~ PDO_full_lag + (1 | Plot), data = PDO_df)
...
## run models
ONI_half_mod <- lmer(Size ~ ONI_half + (1 | Plot), data = ONI_df)
ONI_full_mod <- lmer(Size ~ ONI_full + (1 | Plot), data = ONI_df)
ONI_half_lag_mod <- lmer(Size ~ ONI_half_lag + (1 | Plot), data = ONI_df)
ONI_full_lag_mod <- lmer(Size ~ ONI_full_lag + (1 | Plot), data = ONI_df)
...
print(ONI_AIC)
```
There is equal support for the PDO half_lag (AIC = 10704.14) and full_lag model (AIC = 10705.02).
