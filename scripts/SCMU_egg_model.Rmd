...
bm_obs <- lmer(Size ~ EggOrder + BEUTI + NPGO + ONI + (1 | Observer), data = SCMUdf, REML = TRUE)
...
plot(SCMU.BEUTI$BEUTI[1:100],y = apply(pv,2,mean)[1:100],xlab = "Anchovy",ylab = "Egg Size",type = "l",ylim = c(1500,2500))
