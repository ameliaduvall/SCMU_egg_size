...
cov_names[use_set[top6[1],]] # Egg order, BEUTI, NPGO
cov_names[use_set[top6[2],]] # Egg order, NPGO, ONI
cov_names[use_set[top6[3],]] # Egg order, ANCHL, BEUTI, SST (>2 AIC)
cov_names[use_set[top6[4],]] # Egg order, PDO, SST (>2 AIC)
cov_names[use_set[top6[5],]] # Egg order, PDO (>2 AIC)
cov_names[use_set[top6[6],]] # Egg order, BEUTI, SST (>2 AIC)
